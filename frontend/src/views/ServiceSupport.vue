    ...
    <section class="py-20 px-4 bg-gradient-to-b from-background to-muted/20">
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
          ...
          <div class="text-xl text-muted-foreground max-w-4xl mx-auto space-y-6">
            <p>
            ...
            <div class="text-left max-w-3xl mx-auto">              
              <div class="space-y-4">
                ...
                <div class=" rounded-lg p-4 ">
                  <h4 class="font-semibold text-lg mb-2 text-foreground">Оперативная техническая поддержка</h4>
                  <p class="text-muted-foreground">
            ...
            <div class="bg-primary/10 rounded-lg p-6 border border-primary/20">
              <h3 class="text-2xl font-semibold mb-4 text-foreground">Нужна помощь? Отправьте заявку!</h3>
              ...
              <div class="space-y-2 text-left max-w-2xl mx-auto">
                <p class="flex items-center">
                  ...
                  <span>по электронной почте: <strong>service@spectronxray.ru</strong></span>
                </p>
                <p class="flex items-center">
                  <svg class="w-5 h-5 text-primary mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                  </svg>
                  <span>по телефону: <strong>+7 (812) 458-99-99</strong></span>
                </p>
                <p class="flex items-center">
                  <svg class="w-5 h-5 text-primary mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                  </svg>
                  <span>в мессенджерах на номер: <strong>+7 (901) 304-44-44</strong></span>
                </p>
              </div>
            </div>
            
            <div class="text-center mt-8">
              <button class="bg-primary text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors font-medium text-lg">
                Отправить заявку
              </button>
            </div>
          </div>
        ...
        <div class="text-center mb-16">
          <h1 class="text-4xl md:text-3xl font-bold mb-6 bg-gradient-to-r from-primary to-primary/70 bg-clip-text ">
            Сервисные центры
          </h1>
          <div class="text-xl text-muted-foreground max-w-4xl mx-auto space-y-6">
            ...
            <div class="text-left max-w-3xl mx-auto">
              ...
              <div class="space-y-4">
                <div class=" rounded-lg p-4 ">
                  <p class="text-muted-foreground">
                    Все наши партнеры — это проверенные специалисты, которые прошли обучение и подготовку на нашем производстве и имеют сертификаты установленного образца, дающие право проводить полное обслуживание спектрометров и анализаторов «СПЕКТРОСКАН».</p>
                </div>
                
                <div class=" rounded-lg p-4 ">
                  <h4 class="font-semibold text-lg mb-2 text-foreground">Выгодное постгарантийное обслуживание</h4>
                  <p class="text-muted-foreground">
                    После окончания гарантии НПО «СПЕКТРОН» предлагает разумные цены на сервисные работы, ремонт и оригинальные запасные части.
                  </p>
                  <p class="text-muted-foreground">
