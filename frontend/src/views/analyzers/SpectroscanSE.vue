        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p class="text-xl text-muted-foreground mb-8">
              Энергодисперсионный анализатор нового поколения для определения серы
            </p>
          ...
          <div class="relative">
            ...
            <div class="flex gap-2 mt-4 justify-center">
              <img 
                ...
                :key="index"
                :src="image" 
                :alt="`СПЕКТРОСКАН SE - изображение ${index + 1}`"
                ...
                <div class="space-y-4">
                  ...
                  <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="flex justify-between">
                        <span class="font-medium">ГОСТ:</span>
                        <span>ГОСТ 32139-2019</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="font-medium">Международные стандарты:</span>
                        <span>ISO 20847, ASTM D4294</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="p-4 bg-muted/30 rounded-lg">
                      ...
                      <ul class="space-y-2">
                        <li class="flex items-start gap-2">
                          ...
                          <span>быстрое определение серы (1-2 минуты);</span>
                        </li>
                        <li class="flex items-start gap-2">
                          <span class="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                          <span>соответствие ГОСТ 32139-2019;</span>
                        </li>
                        <li class="flex items-start gap-2">
                          <span class="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                          <span>соответствие ISO 20847, ASTM D4294;</span>
                        </li>
                        <li class="flex items-start gap-2">
                          <span class="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
    ...
    >
      <div class="relative max-w-7xl max-h-[90vh] w-full mx-4">
        ...
        <img 
          ...
          :alt="`СПЕКТРОСКАН SE - изображение ${currentImageIndex + 1}`"
