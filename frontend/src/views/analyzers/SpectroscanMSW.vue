...
const tasks = [
  {
    title: "Определение серы в нефтепродуктах",
    description: "Высокоточное определение массовой доли серы в нефти и нефтепродуктах с использованием арбитражного метода",
    application: "Нефтеперерабатывающие заводы, лаборатории контроля качества"
  },
  {
    title: "Анализ металлов в топливе",
    description: "Определение содержания свинца, железа и марганца в автомобильном топливе",
    application: "Автомобильная промышленность, топливные компании"
  },
  {
    title: "Контроль качества дистиллятов",
